...
export default function HandoffPage({ appState }) {
    ...
    () => [
      {
        ...
        details: (
          <>
            ...
            <div style={styles.detailLine}>
              <b>What:</b> If the previous coordinator sent you a JSON file/export,
              paste it into Import and click Import.
            </div>
            <div style={styles.detailLine}>
              <b>Why:</b> This restores volunteers, settings, and week history so you don’t
              start from scratch.
            </div>
          </>
        ),
      },
      {
        ...
        details: (
          <>
            ...
            <div style={styles.detailLine}>
              <b>Tip:</b> If anything looks off, fix it here first so you don’t have to
              resend corrected texts later.
            </div>
          </>
        ),
      },
      {
        ...
        details: (
          <>
            ...
            <div style={styles.detailLine}>
              <b>Check:</b> Core roles are assigned (Chairperson, List Coordinator, Meeting
              Steward, Discussion Lead, Big Book Lead).
            </div>
            <div style={styles.detailLine}>
              <b>Also:</b> Verify phone numbers and that volunteers who can serve are marked{" "}
              <b>Active</b>.
            </div>
          </>
        ),
      },
      {
        ...
        details: (
          <>
            ...
            <div style={styles.detailLine}>
              <b>Expected:</b> Core roles appear in “Required Roles” and can be added (or
              are already added, depending on your auto-add setup).
            </div>
            <div style={styles.detailLine}>
      ...
      },
      {
        ...
        details: (
          <>
            <div style={styles.detailLine}>
              <b>Mark Yes:</b> sets status to <b>Confirmed</b> and updates last confirmed
              date for cooldown logic.
            </div>
            <div style={styles.detailLine}>
      ...
      },
      {
        ...
        oneLiner:
          "Send follow-up to anyone still Invited; mark No Response by end of day.",
        details: (
          <>
            <div style={styles.detailLine}>
            ...
            <div style={styles.detailLine}>
              <b>Then:</b> If no response by Wednesday evening, tap{" "}
              <b>Mark No Response</b> and invite a replacement.
            </div>
          </>
        ),
      },
      {
        ...
        details: (
          <>
            <div style={styles.detailLine}>
              <b>Rule:</b> Finalize unlocks the “Friday Reminder” section and signals you
              should stop inviting (unless a cancellation happens).
            </div>
            <div style={styles.detailLine}>
              <b>Target:</b> Minimum is your app setting (often 9). Preferred is typically
              higher.
            </div>
          </>
        ),
      },
      {
        ...
        details: (
          <>
            <div style={styles.detailLine}>
              <b>Where:</b> Coordinator tab → “Friday Reminder (Confirmed Only)” appears
              after finalize.
            </div>
            <div style={styles.detailLine}>
              <b>If cancellation:</b> Use <b>Add Last-Minute Volunteer</b> → send invite →
              mark yes/no like normal.
            </div>
          </>
        ),
      },
  ...
  return (
    <div className="handoffPage">
      <h2 style={{ marginTop: 0 }}>Handoff Mode</h2>

      {/* Mission */}
      <section className="handoff-card" style={styles.card}>
      ...
      <section className="handoff-card" style={styles.card}>
        <div className="handoff-row" style={styles.row}>
          <div style={{ fontWeight: 900 }}>New Coordinator Checklist</div>
          <div className="handoff-progressPill" style={styles.progressPill}>
            {doneCount}/{totalCount} done
          </div>
        </div>

        <div className="handoff-steps" style={{ marginTop: 10, display: "grid", gap: 10 }}>
          {steps.map((s, idx) => {
            const isOpen = openKey === s.key;
            const isDone = !!checked[s.key];

            return (
              <div key={s.key} className="handoff-stepCard" style={styles.stepCard}>
                <div className="handoff-stepTopRow" style={styles.stepTopRow}>
                  <label className="handoff-checkRow" style={styles.checkRow}>
                    <input
                      type="checkbox"
                      checked={isDone}
                    ...
                    <div style={{ minWidth: 0 }}>
                      <div className="handoff-stepTitleRow" style={styles.stepTitleRow}>
                        <div className="handoff-stepNum" style={styles.stepNum}>
                          {idx + 1}
                        </div>
                        <div className="handoff-stepTitle" style={styles.stepTitle}>
                          {s.title}
                        </div>
                      </div>
                      <div className="handoff-oneLiner" style={styles.oneLiner}>
                        {s.oneLiner}
                      </div>
                    </div>
                  </label>
                ...
                {isOpen ? (
                  <div className="handoff-detailsBox" style={styles.detailsBox}>
                    {s.details}
                  </div>
                ) : null}
              </div>
        ...
        <div className="handoff-noteBox" style={styles.noteBox}>
...
const styles = {
  ...
  // ✅ small safety tweak: allow wrapping on narrow screens
  row: {
    display: "flex",
    alignItems: "center",
  ...
  // ✅ safety: allow wrap so the Details button doesn’t cause overflow
  stepTopRow: {
    display: "flex",
